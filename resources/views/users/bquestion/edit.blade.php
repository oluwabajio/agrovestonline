...
@section('content2')
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ask Questions</li>
      </ol>
     {{-- form starts here --}}
        ...
        <div class="container ">
            <div class="col-md-6 mx-auto">
                <div class="form-area">  
                    <form role="form" method="POST" action="{{url('user/basic-question/'.$basic->id)}}">
                        {{csrf_field()}}
                    <br style="clear:both">
                                ...
                                <div class="form-group">
                                <textarea class="form-control" type="textarea" id="answer1" name="answer1" placeholder="Answer 1" value="{{$basic->answer1}}" maxlength="440" rows="7" readonly>{{$basic->answer1}}</textarea>                    
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="question2" name="question2" value="{{$basic->question2}}" placeholder="Question 2">
                                </div>
                                <div class="form-group">
                                <textarea class="form-control" type="textarea" id="answer2" name="answer2" placeholder="Answer 2" value="{{$basic->answer2}}" maxlength="440" rows="7" readonly>{{$basic->answer2}}</textarea>            
                                </div>
