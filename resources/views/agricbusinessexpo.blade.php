  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        ...
        <a class="navbar-brand js-scroll-trigger" href="{{url('/')}}">Agrovest</a>
...
<div  class="one withsmallpadding ppb_text" style="text-align:left;padding:40px 0 40px 0;background-color:#000000;color:#ffffff !important;" ><div class="standard_wrapper"><div class="page_content_wrapper"><div class="inner"><div style="margin:auto;width:70%"></p>
<div class="one_half " style="">
<strong>WHERE</strong></p>
<p>Pistis Conference Centre,<br />
1 Resurrection Drive,<br />
Second Turn after Oando Filling Station, Jakande (Salem Bus stop), Lekki/Epe Expressway, Lagos.</p>
</div>
<div class="one_third " style="">
<strong>WHEN</strong></p>
<p>Friday, August 24th, 2018</p>
</div>
<p>
</div></div>
    </section>
    ...
    <section id="topics" style="padding-top: 0px;">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Topics</h2>
            <h3 class="section-subheading text-muted">Below are Some Of The Featured Topics</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <ul class="timeline">
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <!-- <h4>2009-2011</h4> -->
                    <h4 class="subheading">Food Security</h4>
                  </div>
              ...
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <!-- <h4>March 2011</h4> -->
                    <h4 class="subheading">Potentials In Agriculture</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                  </div>
              ...
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <!-- <h4>December 2012</h4> -->
                    <h4 class="subheading">Agricultural Business Investment</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                  </div>
              ...
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <!-- <h4>July 2014</h4> -->
                    <h4 class="subheading">Goverment Input In Agriculture</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>
                  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Below are some of our Invited Guest Speakers</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4">
    ...
    <script src="{{ asset('assets/vendor/js/jqBootstrapValidation.js') }}"></script>
    <script src="{{ asset('assets/vendor/js/contact_me.js') }}"></script>

    <!-- Custom scripts for this template -->
    <script src="{{ asset('assets/vendor/js/agency.min.js') }}"></script>
